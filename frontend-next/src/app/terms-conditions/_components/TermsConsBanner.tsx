...
export default function TermsConsBanner() {
    return (
        <section className="bg-magenta600 relative w-full min-h-[450px] md:min-h-[450px] lg:h-[400px] overflow-hidden flex items-end pt-[80px] lg:pt-0">
            ...
            <div className="container mx-auto max-w-[1440px] px-6 md:px-12 lg:px-[80px] pb-0 lg:pb-[60px] w-full h-full relative flex flex-col lg:flex-row items-center lg:items-end">
                ...
                <div className="relative z-10 w-full text-center lg:text-left mb-6 md:mb-10 lg:mb-0 md:mt-6 lg:mt-0">
                    <h1 className="HeadingMBold lg:HeadingXLBold text-white uppercase sm:normal-case break-words max-w-[600px] lg:max-w-none mx-auto lg:mx-0">
                        Terms & Conditions
                    </h1>
                </div>
                ...
                <div className="relative lg:absolute lg:top-[90px] lg:left-[807px] w-full max-w-[327px] md:max-w-[500px] lg:max-w-none lg:w-[582px] h-auto pointer-events-none select-none">
                    <Image
                        ...
                        height={562}
                        priority
                        className="w-full h-full object-contain object-bottom md:scale-100 lg:scale-100"
                    />
                </div>
            </div>
        </section>
